...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [me](https://t.me/source_code_z)"
...
** Channel:** [Z BOTS UPDATES](https://t.me/Z_Bots)
...
You Can Suggest Any Bot Making #newadb and bot name on Z Bots SUPPORT
**For Support:** Join @Z_Bots"""
